...
| [minor-data-protection](minor-data-protection/README.md) | In Review | A central minor-data policy guard that every collection/share/ad/profiling point consults to enforce data-minimization defaults and a binding no-behavioral-ads constraint for a known minor, for as long as they are a minor. |
